        ...
        <main className="flex-1 p-6 lg:p-8 overflow-y-auto">
          <div className="space-y-6 max-w-5xl">
            ...
            <div>
              ...
              <p className="text-gray-400">Manage your restaurant preferences and configurations</p>
            </div>
            ...
            <div className="flex gap-2 border-b border-gray-700">
              {[
                ...
                { id: "appearance" as const, label: "Appearance", icon: "M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" },
            ...
            {activeTab === "general" && (
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6">
                  <h3 className="text-xl font-bold text-white mb-4">Restaurant Information</h3>
                  <div className="space-y-4">
                    <div>
                      <label className="block text-gray-300 text-sm font-medium mb-2">Restaurant Name</label>
                      <input
                        type="text"
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <select className="w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded-lg text-white focus:border-orange-500 focus:outline-none" suppressHydrationWarning>
                          <option>USD ($)</option>
                          <option>EUR (€)</option>
                          <option>GBP (£)</option>
                          <option>VND (₫)</option>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      ...
                      { name: "Auto", color: "from-gray-900 via-gray-700 to-white" },
                    ].map((theme) => (
                      <button
                        key={theme.name}
                        className={`p-4 bg-gradient-to-br ${theme.color} border-2 ${
                          theme.name === "Dark" ? "border-orange-500" : "border-gray-700"
                        } rounded-xl hover:border-orange-500 transition-all`}
                        suppressHydrationWarning
                      >
                        <div className="text-center">
                          <p className={`font-bold ${theme.name === "Light" ? "text-gray-900" : "text-white"}`}>{theme.name}</p>
                        </div>
                      </button>
                    ))}
                  </div>
                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6">
                  ...
                  <div className="grid grid-cols-6 gap-4">
                    {["orange", "blue", "green", "purple", "pink", "red"].map((color) => (
                      <button
                        key={color}
                        className={`h-12 bg-${color}-500 rounded-lg hover:scale-110 transition-transform ${
                          color === "orange" ? "ring-2 ring-white ring-offset-2 ring-offset-gray-900" : ""
                        }`}
                        suppressHydrationWarning
                      />
                    ))}
                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6">
                  <h3 className="text-xl font-bold text-white mb-4">Display Options</h3>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-white font-medium">Compact Mode</p>
                        <p className="text-gray-400 text-sm">Reduce spacing between elements</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" className="sr-only peer" suppressHydrationWarning />
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" defaultChecked className="sr-only peer" suppressHydrationWarning />
                        <div className="w-11 h-6 bg-gray-700 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-orange-500 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-orange-500"></div>
                      </label>
                    </div>
                  </div>
            ...
            {activeTab === "notifications" && (
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6">
                  <h3 className="text-xl font-bold text-white mb-4">Order Notifications</h3>
                  <div className="space-y-4">
                    {[
                      { title: "New Orders", desc: "Get notified when new orders arrive" },
                      { title: "Order Updates", desc: "Updates on order status changes" },
                      { title: "Order Completion", desc: "When orders are completed" },
                    ].map((item) => (
                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    {[
                      { title: "Table Updates", desc: "Changes in table status" },
                      { title: "Staff Alerts", desc: "Staff check-in/out notifications" },
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <button className="px-6 py-2 bg-gradient-to-r from-orange-600 to-orange-500 text-white rounded-lg font-medium hover:from-orange-500 hover:to-orange-400 transition-all" suppressHydrationWarning>
                      Update Password
                    </button>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-red-500/20 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    <button className="px-6 py-2 bg-red-500/10 text-red-500 border border-red-500/20 rounded-lg font-medium hover:bg-red-500 hover:text-white transition-all" suppressHydrationWarning>
                      Delete Account
                    </button>
                  </div>
                </div>
            ...
            <div className="flex justify-end gap-3 pt-6">
              <button className="px-6 py-2 bg-gray-700 text-white rounded-lg hover:bg-gray-600 transition-all" suppressHydrationWarning>
                Cancel
              </button>
              <button className="px-6 py-2 bg-gradient-to-r from-orange-600 to-orange-500 text-white rounded-lg font-medium hover:from-orange-500 hover:to-orange-400 transition-all" suppressHydrationWarning>
                Save Changes
