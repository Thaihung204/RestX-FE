...
const highlights = [
  {
    icon: <UploadOutlined />,
    textKey: "tour.tables.highlights.upload_floor_map",
  },
  {
    icon: <PlusCircleOutlined />,
    textKey: "tour.tables.highlights.add_and_name_table",
  },
  {
    icon: <EyeOutlined />,
    textKey: "tour.tables.highlights.real_position_view",
  },
];
...
const panoramaHighlights = [
  {
    icon: <CameraOutlined />,
    textKey: "tour.tables.panorama.highlights.upload_360",
  },
  {
    icon: <CompassOutlined />,
    textKey: "tour.tables.panorama.highlights.rotate_preview",
  },
  {
    icon: <RadarChartOutlined />,
    textKey: "tour.tables.panorama.highlights.increase_conversion",
  },
];
...
const qrHighlights = [
  {
    icon: <QrcodeOutlined />,
    textKey: "tour.tables.qr.highlights.unique_qr_per_table",
  },
  {
    icon: <CheckCircleOutlined />,
    textKey: "tour.tables.qr.highlights.auto_bind_order",
  },
  {
    icon: <SafetyOutlined />,
    textKey: "tour.tables.qr.highlights.no_cross_table_mixup",
  },
  {
    icon: <ThunderboltOutlined />,
    textKey: "tour.tables.qr.highlights.faster_service",
  },
];
                ...
                <motion.div variants={featureItem}>
                  <Title
                    ...
                    <span style={{ color: "#10B981" }}>
                      {t("tour.tables.section_1.title_highlight")}
                    </span>{" "}
            ...
            <Col xs={24} lg={11}>
              <motion.div
                ...
                <div
                  ...
                  {/* Three.js panorama */}
                  <PanoramaViewer
                    src="/images/example/panorama.png"
                    height={300}
                  />
              ...
              <motion.div
                ...
                <motion.div variants={featureItem}>
                  <Title
                    ...
                    <span style={{ color: "#10B981" }}>
                      {t("tour.tables.panorama.title_highlight")}
                    </span>{" "}
            ...
            <Row gutter={[64, 48]} align="middle">
              ...
              <Col xs={24} lg={12}>
                <motion.div
                  ...
                  animate={panoramaInView ? "visible" : "hidden"}
                  variants={stagger}>
                  <motion.div variants={featureItem}></motion.div>
                  ...
                  <motion.div variants={featureItem}>
                    <Title
                      ...
                      <span style={{ color: "#10B981" }}>
                        {t("tour.tables.qr.title_highlight")}
                      </span>{" "}
