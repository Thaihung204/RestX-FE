...
export default function AnalyticsTourPage() {
  ...
  const totalOrders = useMemo(
    () => ordersData.reduce((sum, item) => sum + item.total, 0),
    [ordersData],
  );
  const activeFilterLabel = t(
    timeFilters.find((item) => item.value === filter)?.labelKey ??
      "tour.analytics.filters.day",
  );
      ...
      <section style={{ padding: "80px 24px", background: "var(--bg-base)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <motion.div
            ...
            <div
              style={{ textAlign: "center", marginBottom: 64, paddingTop: 30 }}>
              <Title
                level={2}
                style={{
      ...
      <section
        ...
        <div
          style={{
            ...
            height: 300,
            background:
              "radial-gradient(ellipse at center, rgba(255, 56, 11, 0.06) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        <div
              ...
              <Row gutter={[24, 24]}>
                <Col xs={24} lg={12}>
                  <RevenueChart
                    ...
                    subtitle={t("tour.analytics.chart.revenue_by_filter", {
                      filter: activeFilterLabel.toLowerCase(),
                    })}
                  />
                </Col>
                <Col xs={24} lg={12}>
                  <OrdersBarChart
                    ...
                    subtitle={t("tour.analytics.chart.orders_by_filter", {
                      filter: activeFilterLabel.toLowerCase(),
                    })}
                  />
                </Col>
