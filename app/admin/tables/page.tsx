...
export default function TablesPage() {
  ...
  const handleZoneDelete = (zoneId: string) => {
    ...
    // Remove area
    setAvailableAreas(prev => prev.filter(area => area !== zoneId));

    // Move tables to the first available area (or default 'Indoor')
    const fallbackArea = availableAreas.find(a => a !== zoneId) || 'Indoor';
    setTables(prev => prev.map(t =>
      t.area === zoneId ? { ...t, area: fallbackArea as any } : t
    ));
  };
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <div className="flex items-center bg-[var(--card)] p-1 rounded-lg border border-[var(--border)] mr-2">
                <button
              ...
              <button
                ...
                className="px-4 py-2 text-white rounded-lg font-medium transition-all shadow-lg shadow-[#FF380B]/20"
