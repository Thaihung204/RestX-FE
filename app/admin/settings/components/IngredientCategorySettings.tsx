                  ...
                  <tr key={cat.id} className="group transition-colors hover:bg-black/5 dark:hover:bg-white/5">
                    ...
                    <td className="p-4 text-right">
                      <div className="flex justify-end gap-2">
                        ...
                        <Popconfirm title={t("dashboard.manage.ingredient_categories.confirm_delete")} onConfirm={() => cat.id && handleDelete(cat.id)} okText={t("common.actions.yes", { defaultValue: "Yes" })} cancelText={t("common.actions.no", { defaultValue: "No" })} okButtonProps={{ danger: true }}>
