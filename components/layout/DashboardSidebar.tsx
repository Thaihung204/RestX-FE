...
export default function DashboardSidebar() {
  ...
  const navSections: NavSection[] = [
    {
      label: t("dashboard.sidebar.sections.overview", { defaultValue: "Overview" }),
      items: [
        {
          id: "admin",
        ...
        {
          id: "activity",
          label: t("dashboard.sidebar.items.activity", { defaultValue: "Activity" }),
          path: "/admin/activity",
          icon: (
            <svg className="dashboard-sidebar-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
    ...
    {
      label: t("dashboard.sidebar.sections.operations", { defaultValue: "Operations" }),
      items: [
        {
          id: "reservations",
    ...
    {
      label: t("dashboard.sidebar.sections.catalog", { defaultValue: "Catalog" }),
      items: [
        {
          id: "menu",
  ...
  return (
    <aside
      ...
      <div className="dashboard-sidebar-profile">
        <div className="dashboard-sidebar-avatar">A</div>
        {!collapsed && (
